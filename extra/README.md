...
- `mounting_plate/`: 3D-printed mounting plate for ENTS-nodes
- `newbatt`: PCB for powering the ENTS-node from a battery
- `sdi12_breakout`: PCB to expose additional SDI-12 terminals
- `usb_to_ttl/`: PCB for plug-in-play debugging of the esp32
